...
Anda tidak perlu menambahkan tag khusus, cukup pasang CSS diatas tag ```html<head>
```html<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://raw.githubusercontent.com/Playtekno/cssiframeresponsive/main/iframerespo.min.css" />
